    ...
    <Grid container overflow-hidden	>
      <Grid item lg={6} className='min-h-full pl-24 min-h-screen'>
        ...
        <Container maxWidth={false} className="pl-0 flex-row justify-between mt-16">
          <Button className="bg-secondary text-white normal-case px-8 py-2 text-lg ml-2 mr-8 my-2	">I am a User</Button>
          <Button className="bg-tertiary text-white normal-case	px-8 py-2 text-lg	">I am an Admin</Button>
        </Container>
      </Grid>
